...
@Frozen abstract class PConstants {
  ...
  @ProtoAssign static readonly CORNERS = 1 // Draw mode convention to use (x1 y1) to (x2 y2) coordinates
  @ProtoAssign static readonly RADIUS = 2 // Draw mode from the center and using the radius
  @ProtoAssign static readonly CENTER = 3 // Draw from the center using second pair of values as the diameter
  @ProtoAssign static readonly DIAMETER = 3 // Synonym for the CENTER constant. Draw from the center
