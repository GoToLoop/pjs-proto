...
declare namespace pjs.math {
    ...
    class PVector implements Comparable<xyzObj>, Cloneable {
        ...
        static fromAngle(angle: rad, target?: PVector | null): PVector;
        static random2D(target?: PVector | PApplet | null, parent?: PApplet | null): PVector;
        static random3D(target?: PVector | PApplet | null, parent?: PApplet | null): PVector;
        static dist(v1: xyzObj, v2: xyzObj): number;
        static distSq(v1: xyzObj, v2: xyzObj): number;
        static dot(v1: xyzObj, v2: xyzObj): number;
        static cross(v1: xyzObj, v2: xyzObj, target?: PVector | null): PVector;
        static angleBetween(v1: PVector, v2: PVector, magSq1?: number, magSq2?: number, dot?: number): rad;
        static lerp(v1: PVector, v2: PVector, amt: norm, target?: PVector | null): PVector;
        static add(v1: xyzObj, v2: xyzObj, target?: PVector | null): PVector;
        static sub(v1: xyzObj, v2: xyzObj, target?: PVector | null): PVector;
        static subInv(v1: xyzObj, v2: xyzObj, target?: PVector | null): PVector;
        static mult(v: xyzObj, n: xyzObj | number, target?: PVector | null): PVector;
        static div(v: xyzObj, n: xyzObj | number, target?: PVector | null): PVector;
        static mod(v: xyzObj, n: xyzObj | number, target?: PVector | null): PVector;
        ...
        cross(v1: xyzObj, v2?: PVector, target?: PVector | null): PVector;
